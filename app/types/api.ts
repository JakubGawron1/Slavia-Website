 ...
 *
 * Źródło kontraktu: `openapi/openapi.snapshot.json` (CI) lub `../Slavia-backend/src/embed/openapi.json`.
 * Po zmianie backendu: `pnpm openapi:snapshot` → `pnpm openapi:types` → commit snapshot + generated.
 *
