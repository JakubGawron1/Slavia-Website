...
export const PANEL_NAV_MODULES: PanelNavModuleDef[] = [
  ...
  mod('athlete', 'obecnosc', 'Najczęstsze', 'Obecność i QR', 'Kalendarz, skaner, zgłoszenia', 'i-lucide-user-check', KLUB_SHARED_ROUTES.obecnosc, 'text-primary', 'bg-primary/12', true),
  mod('athlete', 'czat', 'Najczęstsze', 'Czat z trenerem', 'Wiadomości 1:1', 'i-lucide-messages-square', KLUB_SHARED_ROUTES.czat, 'text-info', 'bg-info/14', true),
  mod('athlete', 'powiadomienia', 'Najczęstsze', 'Powiadomienia', 'Alerty od kadry', 'i-lucide-bell', KLUB_SHARED_ROUTES.powiadomienia, 'text-amber-600', 'bg-amber-500/12', true),
  mod('athlete', 'dziennik', 'Trening i progres', 'Dziennik treningów', 'Wpisy po jednostkach', 'i-lucide-book-marked', '/athlete/dziennik', 'text-info', 'bg-info/12', true),
  ...
  mod('athlete', 'trener_ai', 'Trening i progres', 'Trener AI', 'Dwubój, plany, regeneracja', 'i-lucide-sparkles', '/athlete/ai-coach', 'text-violet-600', 'bg-violet-500/12', true),
  ...
  mod('athlete', 'kalendarz_klubu', 'Klub i narzędzia', 'Kalendarz klubu', 'Treningi i zawody', 'i-lucide-calendar-days', PUBLIC_ROUTES.kalendarz, 'text-purple-600', 'bg-purple-500/12'),
  mod('athlete', 'feed', 'Klub i narzędzia', 'Feed klubowy', 'Aktualności, ogłoszenia, kalendarz', 'i-lucide-rss', KLUB_SHARED_ROUTES.feed, 'text-primary', 'bg-primary/10'),
  ...
  mod('trainer', 'obecnosc', 'Najczęstsze', 'Lista obecności', 'Statusy i weryfikacja', 'i-lucide-user-check', KLUB_SHARED_ROUTES.obecnosc, 'text-indigo-600', 'bg-indigo-500/10', true),
  ...
  mod('trainer', 'czat', 'Najczęstsze', 'Czat z zawodnikami', 'Wiadomości 1:1', 'i-lucide-messages-square', KLUB_SHARED_ROUTES.czat, 'text-info', 'bg-info/12', true),
  mod('trainer', 'kalendarz', 'Planowanie i monitoring', 'Kalendarz', 'Zawody i treningi klubu', 'i-lucide-calendar', PUBLIC_ROUTES.kalendarz, 'text-purple-500', 'bg-purple-500/10'),
  ...
  mod('trainer', 'trener_ai', 'Planowanie i monitoring', 'Trener AI', 'Groq: plany i regeneracja', 'i-lucide-sparkles', '/trainer/ai-coach', 'text-violet-600', 'bg-violet-500/12', true),
  ...
  mod('trainer', 'aktualnosci', 'Klub i treści', 'Aktualności', 'Wpisy na stronie', 'i-lucide-newspaper', PUBLIC_ROUTES.aktualnosci, 'text-amber-600', 'bg-amber-500/10'),
  mod('trainer', 'feed', 'Klub i treści', 'Feed klubowy', 'Aktualności, ogłoszenia, kalendarz', 'i-lucide-rss', KLUB_SHARED_ROUTES.feed, 'text-primary', 'bg-primary/10'),
  mod('trainer', 'wyzwania', 'Klub i treści', 'Wyzwania miesiąca', 'Ranking aktywności', 'i-lucide-flame', KLUB_SHARED_ROUTES.wyzwania, 'text-orange-600', 'bg-orange-500/10'),
  ...
  mod('admin', 'powiadomienia', 'Najczęstsze', 'Powiadomienia', 'Alerty systemowe', 'i-lucide-bell', KLUB_SHARED_ROUTES.powiadomienia, 'text-amber-600', 'bg-amber-500/10', true),
  ...
  mod('admin', 'aktualnosci', 'Treści publiczne', 'Aktualności', 'Wpisy na stronie', 'i-lucide-newspaper', PUBLIC_ROUTES.aktualnosci, 'text-orange-500', 'bg-orange-500/10'),
  mod('admin', 'ogloszenia', 'Treści publiczne', 'Ogłoszenia', 'Tablica klubu', 'i-lucide-megaphone', PUBLIC_ROUTES.ogloszenia, 'text-violet-500', 'bg-violet-500/10'),
  mod('admin', 'galeria', 'Treści publiczne', 'Galeria', 'Zdjęcia', 'i-lucide-images', PUBLIC_ROUTES.galeria, 'text-pink-500', 'bg-pink-500/10'),
  ...
  mod('admin', 'feed', 'Treści publiczne', 'Feed klubowy', 'Aktualności, ogłoszenia, kalendarz', 'i-lucide-rss', KLUB_SHARED_ROUTES.feed, 'text-primary', 'bg-primary/10'),
