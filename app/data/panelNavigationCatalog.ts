...
export const PANEL_NAV_MODULES: PanelNavModuleDef[] = [
  ...
  mod('athlete', 'trener_ai', 'Trening i progres', 'Trener AI', 'Dwubój, plany, regeneracja', 'i-lucide-sparkles', '/athlete/trener-ai', 'text-violet-600', 'bg-violet-500/12', true),
  ...
  mod('trainer', 'trener_ai', 'Planowanie i monitoring', 'Trener AI', 'Groq: plany i regeneracja', 'i-lucide-sparkles', '/trainer/trener-ai', 'text-violet-600', 'bg-violet-500/12', true),
