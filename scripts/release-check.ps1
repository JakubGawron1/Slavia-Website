...
if ($BffUrl) {
  Write-Host "[5/5] optional BFF AI public status"
  $bff = $BffUrl.TrimEnd('/')
  ...
  Write-Host "[5/5] skip BFF AI healthcheck (ustaw SLAVIA_BFF_URL=http://127.0.0.1:3000 aby włączyć)"
}
